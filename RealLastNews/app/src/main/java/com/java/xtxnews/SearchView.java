...
public class SearchView extends LinearLayout {
    ...
    // 数据库变量
    // 用于存放历史搜索记录
    private SearchRecordSQLite helper ;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int defaultColor = context.getColor(R.color.SearchText); // 默认颜色 = 灰色
        ...
        // 搜索框颜色
        int defaultColor2 = context.getColor(R.color.SearchBackground); // 默认颜色 = 白色
    ...
    private void init(){
        ...
        helper = new SearchRecordSQLite(context);
        ...
        et_search.setOnKeyListener(new OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN) {
                    ...
                    intent.putExtra("searchKeyword",et_search.getText());
        ...
        searchBack.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(context, "取消搜索", Toast.LENGTH_SHORT).show();
            }
        });
